...
**v2.12.1 更新**：`/dbs-agent-migration` 补齐 Grok Build 兼容。迁移目标从 Claude Code / Codex 双端扩展到 Claude Code / Codex / Grok 三端；同步更新 marketplace、主入口路由和 release 包说明，并清掉会让用户误以为需要本地 `js` 脚本的过时表述。
